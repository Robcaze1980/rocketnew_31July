...
const Sidebar = () => {
  ...
  const managerNavigationItems = [
    { label: 'Unified Dashboard', path: '/manager-dashboard/overview', icon: 'BarChart3' },
    { label: 'Performance Graphs', path: '/manager-dashboard/performance', icon: 'TrendingUp' },
    { label: 'Product Profitability', path: '/manager-dashboard/profitability', icon: 'DollarSign' },
    { label: 'Team Management', path: '/manager-dashboard/team', icon: 'Users' },
    { label: 'Double Claim Alerts', path: '/manager-dashboard/alerts', icon: 'AlertTriangle' },
    { label: 'Advanced Analytics', path: '/manager-dashboard/reports', icon: 'FileText' },
    { label: 'Department KPIs', path: '/department-kpis', icon: 'TrendingUp' },
    { label: 'Report by Salesperson', path: '/team-reports', icon: 'Grid3X3' },
  ]?.filter(item => item && item?.label && item?.path && item?.icon);
