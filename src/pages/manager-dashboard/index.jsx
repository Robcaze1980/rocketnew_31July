...
const ManagerDashboard = () => {
  ...
  const getActiveTabFromUrl = () => {
    ...
    if (path.includes('/manager-dashboard/performance')) return 'performance';
    if (path.includes('/manager-dashboard/profitability')) return 'profitability';
    if (path.includes('/manager-dashboard/team')) return 'team';
    if (path.includes('/manager-dashboard/alerts')) return 'alerts';
    if (path.includes('/manager-dashboard/reports')) return 'reports';
                ...
                {tabs?.map((tab) => {
                  ...
                  <button
                      ...
                      onClick={() => {
                        ...
                        const tabPaths = {
                          overview: '/manager-dashboard/overview',
                          performance: '/manager-dashboard/performance',
                          profitability: '/manager-dashboard/profitability',
                          team: '/manager-dashboard/team',
                          alerts: '/manager-dashboard/alerts',
                          reports: '/manager-dashboard/reports'
                        };
                        navigate(tabPaths[tab?.id] || '/manager-dashboard/overview');
                      }}
