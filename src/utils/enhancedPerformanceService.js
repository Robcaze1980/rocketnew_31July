...
const enhancedPerformanceService = {
  ...
  getFilteredPerformanceData: async (userId, filters) => {
    try {
      ...
      // Debug logging
      console.log('EnhancedPerformanceService - Received filters:', filters);
      ...
      // Debug logging
      console.log('EnhancedPerformanceService - Formatted dates:', { startDateStr, endDateStr });
      ...
      console.log('EnhancedPerformanceService - Sales data fetched:', { salesDataLength: salesData?.length, salesError });
