    ...
    <div className="fixed right-0 top-0 h-full w-80 bg-white border-l border-gray-200 shadow-lg z-40 flex flex-col">
          ...
          <div className="space-y-2">
            {suggestedQuestions?.slice(0, 2)?.map((question, index) => (
              <button
                ...
                className="w-full text-left p-2 text-sm bg-blue-50 hover:bg-blue-100 text-blue-700 rounded border border-blue-200 transition-colors"
              >
                {question}
              </button>
            ))}
      ...
      <div className="border-t border-gray-200 p-4">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          ...
          <button
            onClick={() => handleSuggestedQuestion("Show me areas that need improvement")}
            className="p-2 bg-orange-50 hover:bg-orange-100 text-orange-700 rounded border border-orange-200 transition-colors"
          >
            Improvement Areas
          </button>
          <button
          ...
          <button
            onClick={() => handleSuggestedQuestion("What coaching recommendations do you have?")}
            className="p-2 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded border border-blue-200 transition-colors"
          >
            Coaching Tips
          </button>
        </div>
